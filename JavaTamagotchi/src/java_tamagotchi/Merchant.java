...
public class Merchant {
	...
	public static void sell(String product, int price) {
		...
		if (product.equals("Game console (3 gold)"))
			items[0] = false;

		else if (product.equals("Flower (1 gold)"))
			items[2] = false;

		else if (product.equals("Tv (2 gold)"))
			items[3] = false;

		else if (product.equals("Painting (2 gold)"))
			items[1] = false;
	...
	public static int findPrice(String value) {
		...
		if (value.equals("Game console (3 gold)"))
			price = 3;

		else if (value.equals("Flower (1 gold)"))
			price = 1;

		else if (value.equals("Tv (2 gold)"))
			price = 2;

		else if (value.equals("Painting (2 gold)"))
			price = 2;
